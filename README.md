...
Agile group project to rework an **_admissions hub_** to track incoming students into the Galvanize program.
...
![Dashboard](/documentation/images/mcsp-19/mcsp-19_Dashboard.png)
...
_NOTE_ We are using Dockerized environment only in a developer build. When we were ready to deploy it, we didn't use Docker. Refer to the [Deployment Setup](#deployment-setup) section when ready to deploy.

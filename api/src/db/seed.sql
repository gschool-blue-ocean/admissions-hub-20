...
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-01-01', 5, 1, 1, 4, 2, 3, 3, 5, 'Good job!', 12);
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-02-02', 6, 2, 1, 1, 2, 3, 3, 2, 'Terrible', 6);
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-03-03', 7, 3, 1, 3, 2, 3, 3, 3, 'Meh', 9);
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-04-04', 8, 1, 1, 5, 2, 4, 3, 3, 'Great work!', 12);
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-05-05', 9, 2, 1, 2, 2, 3, 3, 4, 'Improvement needed', 9);
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-06-06', 10, 3, 1, 4, 2, 5, 3, 4, 'Keep up the good work!', 13);
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-07-07', 11, 1, 1, 3, 2, 3, 3, 5, 'Impressive!', 11);
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-08-08', 12, 2, 1, 5, 2, 5, 3, 5, 'Excellent performance!', 15);
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-09-09', 13, 3, 1, 3, 2, 4, 3, 4, 'Good effort!', 11);
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-10-10', 14, 1, 1, 4, 2, 4, 3, 4, 'Nice work!', 12);
INSERT INTO attempts (date, student_id, staff_id, question1_id, rating1, question2_id, rating2, question3_id, rating3, notes, rating_score) VALUES ('2023-11-11', 15, 2, 1, 2, 2, 3, 3, 3, 'Keep it up!', 8);
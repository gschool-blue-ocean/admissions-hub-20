    ...
    <>
      {ifNavBarOpen ? (
        <nav className="d-flex flex-column p-0 z-2 position-sticky min-vh-100 sticky-top">
          <div className="d-flex justify-content-center align-items-center mx-4 pb-4 border-bottom">
        ...
        <nav className="pt-2 px-2 d-flex flex-column align-items-center position-sticky min-vh-100 sticky-top">
          ...
          <div
            className={`flex-grow-1 d-flex flex-column-reverse ${style["cursor-pointer"]}`}
            onClick={() => {
              setIfNavBarOpen(true);
              setProfileOptionsOpen(true);
            }}
          >
            <div id="profile-icon" className="m-1 border-top pt-3">
              <svg
                width="34"
                height="34"
                viewBox="0 0 24 24"
